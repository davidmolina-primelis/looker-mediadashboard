- dashboard: ecommerce__global_overview_2
  title: E-commerce | Global Overview 2 test
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: sCm4BeNW1FGXvOiwS3hfg6
  elements:
  - title: Cost
    name: Cost
    model: primelis
  ...
  - title: Selected Period
    ...
    filters:
      parameters.previous_comparison: previous^_period
      parameters.choose_date: this month
  ...
  - title: Facebook Ads Performance
    ...
    pivots: [source_fbads]
    filters:
      parameters.choose_date: 2022-11
      parameters.previous_comparison: previous^_period
    ...
    dynamic_fields: [{category: table_calculation, label: Δ Cost, value_format: !!null '',
        ...
        dimension: source_fbads, args: [fbads_ad_updated_url.selected_period, [!ruby/hash:ActiveSupport::HashWithIndifferentAccess {
              label: "‎", filter: "%Current%"}, !ruby/hash:ActiveSupport::HashWithIndifferentAccess {
              label: Previous, filter: "%Previos%"}], !!null ''], _kind_hint: dimension,
        _type_hint: string}, {category: table_calculation, label: " ∆ Conv", value_format: !!null '',
        value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: conv, args: [fbads_ad_updated_url.total_conversions_fbads],
        _kind_hint: measure, _type_hint: number}, {category: table_calculation, label: " ∆\
          \ CPA", value_format: !!null '', value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
  ...
  - title: Google Ads Performance
    ...
    type: looker_grid
    fields: [googleads_ad.campaign_type, googleads_ad.total_cost,
      googleads_ad.total_impressions, googleads_ad.total_clicks,
      googleads_ad.click_through_rate, googleads_ad.cpm,
      googleads_ad.cpc, googleads_ad.total_conversions,
      googleads_ad.cpa, googleads_ad.conv, googleads_ad.average_order_value,
      googleads_ad.total_conversion_value, googleads_ad.return_on_ad_spend,
      source_fbads]
    pivots: [source_fbads]
    filters:
      parameters.choose_date: 2022-11
      ...
      googleads_ad.impressions: NOT NULL
    sorts: [source_fbads desc, googleads_ad.campaign_type desc]
    limit: 500
    total: true
    dynamic_fields: [{category: table_calculation, label: Δ Cost, value_format: !!null '',
        value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        ...
        _type_hint: number}, {category: table_calculation, label: Δ IMP, value_format: !!null '',
        value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: d_imp, args: [googleads_ad.total_impressions],
        _kind_hint: measure, _type_hint: number}, {category: table_calculation, label: Δ
          Clicks, value_format: !!null '', value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: d_clicks_1, args: [googleads_ad.total_outbound_clicks],
        _kind_hint: measure, _type_hint: number}, {category: table_calculation, label: " ∆\
          \ CTR", value_format: !!null '', value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: ctr, args: [googleads_ad.outbound_click_through_rate],
        _kind_hint: measure, _type_hint: number}, {category: table_calculation, label: " ∆\
          \ CPM", value_format: !!null '', value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: cpm, args: [googleads_ad.cpm], _kind_hint: measure,
        _type_hint: number}, {category: table_calculation, label: " ∆ CPC", value_format: !!null '',
        value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: cpc, args: [googleads_ad.cpc], _kind_hint: measure,
        _type_hint: number}, {category: dimension, description: '', label: Source
          FBAds, value_format: !!null '', value_format_name: !!null '', calculation_type: group_by,
        dimension: source, args: [googleads_ad.selected_period, [!ruby/hash:ActiveSupport::HashWithIndifferentAccess {
              label: "‎", filter: "%Current%"}, !ruby/hash:ActiveSupport::HashWithIndifferentAccess {
              label: Previous, filter: "%Previos%"}], !!null ''], _kind_hint: dimension,
        _type_hint: string}, {category: table_calculation, label: " ∆ Conv", value_format: !!null '',
        value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: conv, args: [googleads_ad.total_conversions],
        _kind_hint: measure, _type_hint: number}, {category: table_calculation, label: " ∆\
          \ CPA", value_format: !!null '', value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: cpa, args: [googleads_ad.cpa], _kind_hint: measure,
        _type_hint: number}, {category: table_calculation, label: " ∆ Conv %", value_format: !!null '',
        value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: conv_1, args: [googleads_ad.conv], _kind_hint: measure,
        _type_hint: number}, {category: table_calculation, label: " ∆ AOV", value_format: !!null '',
        value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: aov, args: [googleads_ad.average_order_value],
        _kind_hint: measure, _type_hint: number}, {category: table_calculation, label: " ∆\
          \ Revenues", value_format: !!null '', value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: revenues, args: [googleads_ad.total_conversion_value],
        _kind_hint: measure, _type_hint: number}, {category: table_calculation, label: " ∆\
          \ ROAS", value_format: !!null '', value_format_name: percent_1, calculation_type: percent_change_from_previous_column,
        table_calculation: roas, args: [googleads_ad.return_on_ad_spend],
        _kind_hint: measure, _type_hint: number}]
    show_view_names: false
    show_row_numbers: false
    transpose: false
    ...
    column_order: ["$$$_row_numbers_$$$", googleads_ad.campaign_type, "‎_googleads_ad.total_cost",
      "‎_d_cost", "‎_googleads_ad.total_impressions", "‎_d_imp", "‎_googleads_ad.total_outbound_clicks",
      "‎_d_clicks_1", "‎_googleads_ad.outbound_click_through_rate", "‎_ctr",
      "‎_googleads_ad.cpm", "‎_cpm", "‎_googleads_ad.cpc", "‎\
        _cpc", "‎_googleads_ad.total_conversions", "‎_conv", "‎_googleads_ad.cpa",
      "‎_cpa", "‎_googleads_ad.conv", "‎_conv_1", "‎_googleads_ad.average_order_value",
      "‎_aov", "‎_googleads_ad.total_conversion_value", "‎_revenues",
      "‎_googleads_ad.return_on_ad_spend", "‎_roas"]
    show_totals: true
    show_row_totals: true
    truncate_header: true
    series_labels:
      googleads_ad.total_outbound_clicks: Clicks
    ...
    series_text_format:
      ...
      googleads_ad.total_impressions:
        align: left
      googleads_ad.total_outbound_clicks:
        align: left
      googleads_ad.outbound_click_through_rate:
        align: left
      googleads_ad.cpm:
        align: left
      googleads_ad.cpc:
